...
class BikeRental:
    ...
    def displaystock(self):
        # displays the bike currently available for rent in the shop
        print("We have currently {} bikes available to rent.".format(self.stock))
        return self.stock
    
    def rentBikeOnHourlyBasis(self,n):
        # rent a bike on hourly basis to a customer
        if n <= 0:
    ...
    def rentBikeOnDailyBasis(self,n):
        # rent a bike on daly basis to a customer
        if n <= 0:
            print("Number of bikes should be positive!")
            return None
        elif n > self.stock:
    ...
    def rentBikeOnWeeklyBasis(self,n):
        # rent a bike on weekly basis to a customer
        if n <= 0:
            print("Number of bikes should be positive!")
            return None
        elif n > self.stock:
    ...
    def returnBike(self,request):
        ...
        if rentalTime and rentalBasis and numOfBikes:
            ...
            print("Thanks for returning your bike. Hop you enjoyed our service!")
